...
__all__ = ['load_image', 'PILBase', 'RandTransform', 'FlipItem', 'DihedralItem', 'PadMode', 'CropPad', 'RandTransform',
           'CropPad', 'RandomCrop', 'OldRandomCrop', 'ResizeMethod', 'Resize', 'RandomResizedCrop', 'RatioResize',
...
from fastcore.transform import BypassNewMeta, DisplayedTransform
from fastcore.dispatch import patch, Tuple, retain_type, delegates
...
class RandomCrop(RandTransform):
    ...
    split_idx,order,store_attrs = None,1,'p,size'
