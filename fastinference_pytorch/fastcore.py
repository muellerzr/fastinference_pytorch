# AUTOGENERATED! DO NOT EDIT! File to edit: 04_fastcore.ipynb (unless otherwise specified).

__all__ = ['is_iter', 'is_coll', 'all_equal', 'noop', 'noops', 'one_is_instance', 'equals', 'NoneType',
           'string_classes', 'FixSigMeta', 'PrePostInitMeta', 'NewChkMeta', 'BypassNewMeta', 'copy_func', 'patch_to',
           'patch', 'patch_property', 'use_kwargs_dict', 'use_kwargs', 'delegates', 'funcs_kwargs', 'method',
           'add_docs', 'docs', 'custom_dir', 'bind', 'GetAttr', 'delegate_attr', 'coll_repr', 'mask2idxs', 'CollBase',
           'cycle', 'zip_cycle', 'is_indexer', 'negate_func', 'L', 'defaults', 'arg0', 'arg1', 'arg2', 'arg3', 'arg4',
           'listable_types']
